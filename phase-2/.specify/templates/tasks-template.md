...
- [ ] T006 [P] Setup API routing under /api/ endpoints with JWT middleware
- [ ] T007 Create base models/entities that all stories depend on
- [ ] T008 Configure error handling and logging infrastructure
- [ ] T009 Setup environment configuration management with DATABASE_URL and BETTER_AUTH_SECRET
